...
class Planner(torch.nn.Module):
    ...
    class Block(torch.nn.Module):
        ...
        def forward(self, img):
            return F.relu(self.b3(self.c3(F.relu(self.b2(self.c2(F.relu(self.b1(self.c1(img)))))))) + self.skip(img))
    ...
    def forward(self, img):
        ...
        # print(cz.shape)
        a = spatial_argmax(torch.squeeze(cz,1))
        # print(a.shape) # H x W
        ...
        a[:,0] = (a[:,0] + 1) * 200 # 400 width
        a[:,1] = (a[:,1] + 1) * 150 # 300 height
        # print(b==a)
